...
$sem=$_POST["se"];
//insert query
$insert="INSERT INTO stud(NAME,ID_NUMBER,SEX,AGE,COLLEGE,DEPARTMENT,YEAR,SEMISTER) values('$nam','$id','$ssx','$age','$coll','$dep','$yer','$sem')";
...
if(!$save)
{
	...
	{
		echo"New student is registered succesfully";
		}
}
...
<input type="reset" name="res" value="Clear"  /><br>
